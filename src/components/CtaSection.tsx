        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center px-8">
            <div className="max-w-2xl mx-auto">
              ...
              <Link to="/anunciantes">
                <button className="inline-flex items-center px-6 py-3 border border-gmv-lime text-gmv-blue !bg-gmv-lime rounded-full hover:bg-gmv-lime/90 transition-all duration-300 hover:scale-105 font-medium">
