...
import { MapPin, Users, Clock, Star, ArrowDown } from "lucide-react";
...
const LocaisParceiros = () => {
  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: '#f7f7f7'}}>
        ...
        <div className="relative pt-48 text-center">
          ...
          <div className="flex justify-center">
            <LiquidButton 
              ...
              onClick={() => {
                const element = document.querySelector('#cliente-section');
                if (element) {
      ...
      {/* Cliente Section */}
      <section id="cliente-section" className="py-16" style={{backgroundColor: '#f7f7f7'}}>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gmv-gray max-w-3xl mx-auto">
                A Fábrica de Monstros foi nossa primeira parceria e hoje é um exemplo de como 
                nossa solução transforma estabelecimentos em pontos de mídia rentáveis.
              </p>
            </div>

            {/* Card Grande do Cliente */}
            <div className="max-w-5xl mx-auto">
              <Card className="overflow-hidden shadow-2xl border-2 border-gmv-lime/20">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center">
                    <CardHeader className="p-0 mb-6">
                      <CardTitle className="text-3xl lg:text-4xl text-gmv-blue mb-4">
                        {cliente.nome}
                      </CardTitle>
                      <p className="text-lg text-gmv-gray leading-relaxed">
                        {cliente.descricao}
                      </p>
                    </CardHeader>
                    ...
                    <CardContent className="p-0 space-y-6">
                      <div className="space-y-4">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-gmv-blue mb-1">Localização</p>
                            <span className="text-gmv-gray">{cliente.endereco}</span>
                          </div>
                        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gmv-gray max-w-3xl mx-auto mb-12">
                Veja onde a GMvision está presente e quantos clientes temos em cada estado brasileiro. 
                Nosso objetivo é expandir nossa rede de parceiros por todo o país.
              </p>
            </div>
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-light font-halenoir text-white leading-tight mb-6">
              Quer ser nosso próximo parceiro?
            </h2>
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Junte-se à Fábrica de Monstros e transforme seu estabelecimento em um ponto de mídia rentável. 
